                                                            ...
                                                            If gia_tri(i_mang) = Cells(j_mang, 7) Then 'sosanh
                                                                ...
                                                                For k_mang = 1 To Model_no(i_mang)
                                                                     ...
                                                                     If Cells(j_mang + k_mang - 1, 2) <> "DEL" Then
                                                                       ...
                                                                       ' If Trim(Cells(j_mang + k_mang - 1, 2)) <> "" Then
                                                                                    ...
                                                                                    ElseIf Trim(Cells(row_sosanh + k_mang - 1, vitricot_var2_zoneB + kc_col_speci_code)) <> "" And Cells(row_sosanh + k_mang - 1, vitricot_var2_zoneB + kc_desinger_note_zoneB) = "" Then
                                                                                                       'so sanh specinote
                                                                                    ...
                                                                                    If Trim(Cells(row_sosanh + k_mang - 1, vitricot_var2_zoneB + kc_col_speci_code)) <> "" And Cells(row_sosanh + k_mang - 1, vitricot_var2_zoneB + kc_desinger_note_zoneB) <> "" Then
                                                                                     ...
                                                                                     End If
                                                                                               ...
                                                                                               'so sanh model no
                                                                                                   'so sanh 300-318 lan luot binh thuong
                                                                          ...
                                                                          'If (Cells(j_mang + k_mang - 1, 2) = "") Then
                                                                            ...
                                                                            'dong i=j ma bang rong
                                                                          
                                                                                    'so sanh dezinnote o dong do
                                                                                'If Trim(Cells(row_sosanh + k_mang - 1, vitricot_var2_zoneB + kc_col_speci_code)) <> "" And Cells(row_sosanh + k_mang - 1, vitricot_var2_zoneB + kc_desinger_note_zoneB) <> "" Then
                                                                                    'neu truong hop nay thi
                                                                               ...
                                                                               ' End If
                                                                           ' elseif cells(j_mang+k_mang-1,2)="DEL"
